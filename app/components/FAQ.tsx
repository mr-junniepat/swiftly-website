...
const faqs = [
  ...
  {
    q: "What is vibe-coded software?",
    a: "Vibe coding is when you use AI tools like Cursor, Bolt, v0, Lovable, or Replit to generate an app quickly. The result usually works as a demo but lacks the architecture, security, error handling, and testing needed for real users. We take that prototype and make it production-ready.",
  },
  {
    q: "Can you fix code generated by any AI tool?",
    a: "Yes. We work with codebases generated by Cursor, Bolt, v0, Lovable, Replit, ChatGPT, Claude, Copilot, and any other AI coding tool. We also fix hand-written prototypes that need the same production hardening.",
  },
  {
    q: "Do you build web and desktop apps too, or just mobile?",
    a: "We build across all platforms — mobile (iOS, Android, cross-platform), web (Next.js, React, Vue, SaaS), and desktop (Electron, Tauri). We also take existing vibe-coded apps on any platform and bring them to production quality.",
  },
];
